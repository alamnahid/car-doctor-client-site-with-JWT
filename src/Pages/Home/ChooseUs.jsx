    ...
    return (
        <div className="mt-32">
            ...
            <div className="flex gap-5 justify-between items-center flex-wrap mt-12">
                ...
                <div data-aos="fade-up" className="w-[10.6rem] h-[9.75rem] rounded-xl border-2 flex flex-col justify-center items-center text-[#444444] hover:bg-[#FF3811] hover:text-white cursor-pointer">
                    <img src={ch5} alt="" />
                    <h1 className=" font-bold text-lg text-center mt-5">Timely Delivery</h1>
                </div>
                <div data-aos="fade-down" className="w-[10.6rem] h-[9.75rem] rounded-xl border-2 flex flex-col justify-center items-center text-[#444444] hover:bg-[#FF3811] hover:text-white cursor-pointer">
                    <img src={ch3} alt="" />
