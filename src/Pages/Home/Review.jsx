 ...
 useEffect(() => {
    ...
    const renderCards = () => {
        ...
        for (let i = 0; i < cardsToShow; i++) {
            ...
            cards.push(
                <div data-aos="fade-right" key={cardIndex} className="card hover:translate-x-[-20px] lg:w-[34.875rem] flex flex-col  justify-center  h-[21.8125rem] rounded-xl border-2 border-[#E8E8E8]">
                    ...
                    <p className="lg:w-[30rem] mt-5 mx-[3.13rem] text-[#737373]">
                        {description}
                    </p>
    ...
    return (
        <div className="mt-32">
            <div className="text-center">
                ...
                <h1 className="mt-5 text-2xl lg:text-[2.8rem] font-bold">What Customer Says</h1>
